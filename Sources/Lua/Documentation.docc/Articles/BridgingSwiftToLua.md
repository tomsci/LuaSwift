...
Include the package <https://github.com/tomsci/LuaSwiftMacros/> to allow metatables to be autogenerated using Swift macros. See the link for more information.
